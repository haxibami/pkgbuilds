...
| python-pymobiledevice3               | 4.14.9            | yes       | Pure python3 implementation for working with iDevices                                                                  |
...
| python-qh3                           | 1.2.0             | yes       | Lightweight QUIC and HTTP/3 implementation in Python (built from latest commit)                                        |
