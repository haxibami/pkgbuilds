...
|hollo|0.6.13|Federated single-user microblogging software|
...
|python-pymobiledevice3|4.26.5|Pure python3 implementation for working with iDevices|
...
|python-qh3|1.5.5|Lightweight QUIC and HTTP/3 implementation in Python|
