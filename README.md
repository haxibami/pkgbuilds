...
| ------------------------------- | ----------- | --------- | ---------------------------------------------------------------------------------------------- |
| bloop-desktop-bin               | 0.3.5       | yes       | A fast code search engine written in Rust (client)                                             |
...
| qdrant                          | 1.1.3       | yes       | Vector Database for the next generation of AI applications                                     |
