...
| ------------------------------------ | ----------- | --------- | ----------------------------------------------------------------------------------------- |
| bloop-desktop-bin                    | 0.6.3       | yes       | A fast code search engine written in Rust (client)                                        |
...
| qdrant                               | 1.8.1       | yes       | Vector Database for the next generation of AI applications                                |
